# manuscript — text for external readers

Everything a reader would reuse to **write** a paper. What was done and concluded lives in
[`../docs/`](../docs/), whose [`final-report.md`](../docs/final-report.md) is the source of truth for
every result; scientific claims come from
[`../pipeline/02`](../pipeline/02_canonical_analysis_and_slides.ipynb), never from a prose file here.
...
| [`writing-guide.md`](writing-guide.md) | The shared writing standard: NMA's **ABC…G** abstract structure, source use, word discipline, slide format. Review drafts against it, not against personal taste |
