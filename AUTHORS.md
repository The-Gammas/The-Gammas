...
Commit history is not a proxy for contribution here: **Valeria Moraga authored files she never
committed** — every commit touching `sandbox/valeria/` was pushed by Jaime, the first saying so in its own
message ([`5cf8f9a`](https://github.com/The-Gammas/The-Gammas/commit/5cf8f9a), *"…hypotheses By
Valeria"*), and `git log -- sandbox/valeria/` returns zero commits authored by her.

Roles below use the [CRediT taxonomy](https://credit.niso.org/); each carries a link to the file, commit
or minutes that evidence it.

## Authors

Listed in the order fixed on 20 Jul 2026 and used in the submitted abstract. That order and those
spellings are canonical; variants in frozen dated records — earlier minutes, GitHub handles — are not
corrected.

| # | Author | CRediT roles | Evidence |
|---|---|---|---|
| 1 | **Valeria Moraga** | Conceptualization · Writing – original draft · Writing – review & editing | Research-question development: [`sandbox/valeria/research-question-development.pdf`](sandbox/valeria/research-question-development.pdf), committed by Jaime as [`5cf8f9a`](https://github.com/The-Gammas/The-Gammas/commit/5cf8f9a); condensed into [`manuscript/research-proposal.md`](manuscript/research-proposal.md) (source contribution declared in its header and closing attribution notes). Abstract drafting, merge and submission: [`manuscript/abstract.md`](manuscript/abstract.md) (SUBMITTED block, 20 Jul 22:12) and [`sandbox/valeria/Abstract_v1.pdf`](sandbox/valeria/Abstract_v1.pdf). Deck ownership: [`manuscript/README.md`](manuscript/README.md), deck row. Presented the introduction (slide 2). |
