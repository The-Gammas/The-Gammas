...
| [`docs/`](docs/README.md) | **writing** | Prose deliverables, kept apart from the notebooks and the code layer. Currently [`05_abstract_proposal.md`](docs/05_abstract_proposal.md): the Valeria + results merge restructured to NMA's **ABC…G**, 246 words, checklist-verified | v2, 2026-07-17; proposal for group review |
