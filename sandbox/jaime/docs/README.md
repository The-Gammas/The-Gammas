# Jaime's sandbox: written documents

Prose deliverables, kept apart from the notebooks and the code layer one level up so that writing and
analysis do not get mixed. Nothing here executes.

**What belongs here:** abstract and manuscript proposals, slide drafts, notes and reasoning written
...
- Sources are recorded in a "what this is based on" table. Claims about a text (word counts, missing
  components) are verified by script, not estimated.
- Bibliography is never duplicated here, it lives in [`manuscript/references.md`](../../../manuscript/references.md).
- **No em dashes.** House style, adopted 17 Jul: they read as machine-written to some readers and
  Arefeh has already raised that concern. Commas, colons and parentheses do the same work.
